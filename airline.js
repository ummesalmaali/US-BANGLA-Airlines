...
function decreaseSpinner(itemMinus) {
    let ticketCount = Number(itemMinus.value);
...
loginBtn.addEventListener("click", function () {
   ...
   const bookNow = document.getElementById("book-now").addEventListener("click", function(){
    const bookNow = prompt("Congratulations!!!You're all set to Fly");
})
